// src/components/ppid/KeberatanTrackClient.tsx
"use client";
...
export function KeberatanTrackClient() {
  ...
  async function handleTrack(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(
        `/api/ppid/track-keberatan?nomor=${encodeURIComponent(nomor.trim())}`,
      );
      if (!res.ok) {
        setError("Nomor keberatan tidak ditemukan.");
        return;
      }
    ...
    <div>
      ...
      >
        <input
          ...
          placeholder="Contoh: PPID-KBR-202501-1234"
          style={{
            flex: 1,
            padding: "10px 14px",
            borderRadius: "9px",
