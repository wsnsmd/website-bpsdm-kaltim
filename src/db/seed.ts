  ...
  const programData = [
    {
      ...
      description:
        "Pendidikan dan pelatihan untuk mencapai persyaratan kompetensi teknis sesuai jabatan.",
    ...
    },
    {
      ...
      description:
        "Pelatihan untuk mencapai persyaratan kompetensi jabatan fungsional.",
      type: "fungsional" as const,
      status: "active" as const,
      isHighlight: true,
      sortOrder: 2,
      durationDays: 5,
    ...
    },
    {
      ...
      description:
        "Membangun wawasan dan bekal bagi ASN dalam mengemban tugas kepemimpinan.",
      type: "manajerial" as const,
      status: "active" as const,
      isHighlight: true,
      sortOrder: 3,
      durationDays: 77,
    ...
    },
    {
      ...
      slug: "pola-apbd",
      description:
        "Program diklat untuk meningkatkan kompetensi aparatur kabupaten/kota.",
      type: "pola-apbd" as const,
      status: "active" as const,
      isHighlight: true,
      sortOrder: 4,
      durationDays: 5,
    ...
    },
    {
      ...
      slug: "pola-kontribusi",
      description:
        "Pelatihan jabatan fungsional melalui mekanisme kontribusi antar instansi.",
      type: "pola-kontribusi" as const,
      status: "active" as const,
      isHighlight: true,
      sortOrder: 5,
      durationDays: 5,
    ...
    },
    {
      ...
      slug: "pola-kemitraan",
      description:
        "Kerjasama strategis antar instansi dalam pengembangan kompetensi ASN.",
      type: "pola-kemitraan" as const,
      status: "active" as const,
      isHighlight: true,
      sortOrder: 6,
      durationDays: 5,
    ...
    },
    {
      ...
      slug: "orientasi-pppk",
      description:
        "Program orientasi bagi Pegawai Pemerintah dengan Perjanjian Kerja.",
      type: "orientasi" as const,
      status: "active" as const,
      isHighlight: false,
      sortOrder: 7,
      durationDays: 5,
